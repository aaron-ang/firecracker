...
mod tests {
    ...
    fn test_parse_put_net_request() {
        ...
        // 3. Success case.
        let expected_config = serde_json::from_str::<NetworkInterfaceSpec>(body).unwrap();
        assert_eq!(
    ...
    fn test_parse_patch_net_request() {
        ...
        // 3. Success case.
        let expected_config = serde_json::from_str::<NetworkInterfaceUpdateSpec>(body).unwrap();
        assert_eq!(
